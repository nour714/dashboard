...
✅ اتعمل **الـ Private Storage Bucket** باسم **`customer-documents`** لتخزين جوازات السفر والمستندات بحد أقصى 15MB وأنواع الملفات المسموحة (`image/jpeg`, `image/png`, `application/pdf`).
...
- **حدود الملفات:** الحد الأقصى لحجم الملف هو 15MB (`15728640` بايت) والأنواع المسموحة هي (`image/jpeg`, `image/png`, `application/pdf`) متوافقة تماماً مع ثوابت `server/src/middleware/upload.js`.
