...
export const en = {
  ...
  hotels: {
    ...
    confirmed: 'CONFIRMED',
    printVoucher: 'Print Official Booking.com PDF',
    ...
    noBookingsDesc: 'Generate your first Booking.com hotel reservation above and save it to the system.',
    reprint: 'Print Booking.com Voucher',
