...
export const icons = {
  compass: (cls = '') => svgWrapper(`
    <circle cx="12" cy="12" r="10"></circle>
    <polygon points="16.24 7.76 14.12 14.12 7.76 16.24 9.88 9.88 16.24 7.76"></polygon>
  `, cls, 20),

  dashboard: (cls = '') => svgWrapper(`
  ...
  payments: (cls = '') => svgWrapper(`
    <rect x="2" y="4" width="20" height="16" rx="2"></rect>
    <line x1="2" y1="10" x2="22" y2="10"></line>
  `, cls, 18),

  refunds: (cls = '') => svgWrapper(`
  ...
  reports: (cls = '') => svgWrapper(`
    <line x1="18" y1="20" x2="18" y2="10"></line>
    <line x1="12" y1="20" x2="12" y2="4"></line>
    <line x1="6" y1="20" x2="6" y2="14"></line>
  `, cls, 18),

  employees: (cls = '') => svgWrapper(`
    <path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"></path>
    <circle cx="12" cy="7" r="4"></circle>
  `, cls, 18),

  activity: (cls = '') => svgWrapper(`
    <polyline points="22 12 18 12 15 21 9 3 6 12 2 12"></polyline>
  `, cls, 18),

  settings: (cls = '') => svgWrapper(`
  ...
  globe: (cls = '') => svgWrapper(`
    <circle cx="12" cy="12" r="10"></circle>
    <line x1="2" y1="12" x2="22" y2="12"></line>
    <path d="M12 2a15.3 15.3 0 0 1 4 10 15.3 15.3 0 0 1-4 10 15.3 15.3 0 0 1-4-10 15.3 15.3 0 0 1 4-10z"></path>
  `, cls, 16),

  arrowRight: (cls = '') => svgWrapper(`
    <line x1="5" y1="12" x2="19" y2="12"></line>
    <polyline points="12 5 19 12 12 19"></polyline>
  `, `${cls} icon-directional`, 16),

  arrowLeft: (cls = '') => svgWrapper(`
    <line x1="19" y1="12" x2="5" y2="12"></line>
    <polyline points="12 19 5 12 12 5"></polyline>
  `, `${cls} icon-directional`, 16),

  check: (cls = '') => svgWrapper(`
    <polyline points="20 6 9 17 4 12"></polyline>
  `, cls, 16),

  alertTriangle: (cls = '') => svgWrapper(`
    <path d="M10.29 3.86L1.82 18a2 2 0 0 0 1.71 3h16.94a2 2 0 0 0 1.71-3L13.71 3.86a2 2 0 0 0-3.42 0z"></path>
    <line x1="12" y1="9" x2="12" y2="13"></line>
    <line x1="12" y1="17" x2="12.01" y2="17"></line>
  `, cls, 18),

  clock: (cls = '') => svgWrapper(`
    <circle cx="12" cy="12" r="10"></circle>
    <polyline points="12 6 12 12 16 14"></polyline>
  `, cls, 16),

  calendar: (cls = '') => svgWrapper(`
  ...
  pencil: (cls = '') => svgWrapper(`
    <path d="M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7"></path>
    <path d="M18.5 2.5a2.121 2.121 0 0 1 3 3L12 15l-4 1 1-4 9.5-9.5z"></path>
  `, cls, 16),

  print: (cls = '') => svgWrapper(`
    <polyline points="6 9 6 2 18 2 18 9"></polyline>
    <path d="M6 18H4a2 2 0 0 1-2-2v-5a2 2 0 0 1 2-2h16a2 2 0 0 1 2 2v5a2 2 0 0 1-2 2h-2"></path>
    <rect x="6" y="14" width="12" height="8"></rect>
  `, cls, 16),

  trash: (cls = '') => svgWrapper(`
    <polyline points="3 6 5 6 21 6"></polyline>
    <path d="M19 6v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6m3 0V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2"></path>
  `, cls, 16),

  close: (cls = '') => svgWrapper(`
    <line x1="18" y1="6" x2="6" y2="18"></line>
    <line x1="6" y1="6" x2="18" y2="18"></line>
  `, cls, 16),

  filter: (cls = '') => svgWrapper(`
    <polygon points="22 3 2 3 10 12.46 10 19 14 21 14 12.46 22 3"></polygon>
  `, cls, 16),

  download: (cls = '') => svgWrapper(`
    <path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"></path>
    <polyline points="7 10 12 15 17 10"></polyline>
    <line x1="12" y1="15" x2="12" y2="3"></line>
  `, cls, 16),

  trendingUp: (cls = '') => svgWrapper(`
    <polyline points="23 6 13.5 15.5 8.5 10.5 1 18"></polyline>
    <polyline points="17 6 23 6 23 12"></polyline>
  `, cls, 14),

  trendingDown: (cls = '') => svgWrapper(`
    <polyline points="23 18 13.5 8.5 8.5 13.5 1 6"></polyline>
    <polyline points="17 18 23 18 23 12"></polyline>
  `, cls, 14),

  moreVertical: (cls = '') => svgWrapper(`
