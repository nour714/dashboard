...
export const createTicketSchema = z.object({
  ...
  returnFlightNumber: z.string().max(20).optional().nullable().transform(v => v ?? undefined),
  origin: z.string().trim().max(100).optional().default(''),
  originTerminal: z.string().max(50).optional().nullable().transform(v => v ?? undefined),
  originAirportName: z.string().max(100).optional().nullable().transform(v => v ?? undefined),
  ...
  destinationAirportName: z.string().max(100).optional().nullable().transform(v => v ?? undefined),
  departureDate: z.string().optional().nullable().transform(v => v ?? undefined),
  arrivalDate: z.string().optional().nullable().transform(v => v ?? undefined),
  returnDepartureDate: z.string().optional().nullable().transform(v => v ?? undefined),
  returnArrivalDate: z.string().optional().nullable().transform(v => v ?? undefined),
  ...
  paymentDate: z.string().optional().nullable().transform(v => v ?? undefined)
...
export const updateTicketSchema = z.object({
  ...
  flightNumber: z.string().max(20).optional().nullable().transform(v => v ?? undefined),
  returnFlightNumber: z.string().max(20).optional().nullable().transform(v => v ?? undefined),
  origin: z.string().max(100).optional().nullable().transform(v => v ?? undefined),
  originTerminal: z.string().max(50).optional().nullable().transform(v => v ?? undefined),
  originAirportName: z.string().max(100).optional().nullable().transform(v => v ?? undefined),
  destination: z.string().max(100).optional().nullable().transform(v => v ?? undefined),
  destinationTerminal: z.string().max(50).optional().nullable().transform(v => v ?? undefined),
  destinationAirportName: z.string().max(100).optional().nullable().transform(v => v ?? undefined),
