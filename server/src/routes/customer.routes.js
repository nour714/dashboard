...
router.post('/:id/passport-document', requireRole('ADMIN', 'AGENT'), uploadRateLimiter, uploadConcurrencyBudget, passportDocUpload.single('passportDocument'), CustomerController.uploadPassportDocument);
