...
import { queryTicketsSchema, createTicketSchema, updateTicketSchema } from '../../backend/src/schemas/ticket.schema.js';
import { queryCustomersSchema, createCustomerSchema, updateCustomerSchema } from '../../backend/src/schemas/customer.schema.js';
import { queryLogsSchema } from '../../backend/src/schemas/audit.schema.js';
import { queryExpensesSchema, createExpenseSchema } from '../../backend/src/schemas/expense.schema.js';
import { createEmployeeSchema } from '../../backend/src/schemas/employee.schema.js';
import { loginSchema, changePasswordSchema } from '../../backend/src/schemas/auth.schema.js';
import { addModificationSchema } from '../../backend/src/schemas/modification.schema.js';
import { addPaymentSchema } from '../../backend/src/schemas/payment.schema.js';
