...
describe('Dark Mode HTML Integrity & Token Verification', () => {
  const customersPath = path.join(rootDir, 'frontend', 'js', 'pages', 'customers.js');
  const employeesPath = path.join(rootDir, 'frontend', 'js', 'pages', 'employees.js');
  const expensesPath = path.join(rootDir, 'frontend', 'js', 'pages', 'expenses.js');
  const dashboardPath = path.join(rootDir, 'frontend', 'js', 'pages', 'dashboard.js');
  const settingsPath = path.join(rootDir, 'frontend', 'js', 'pages', 'settings.js');
