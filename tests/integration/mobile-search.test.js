...
describe('Mobile Topbar Search Verification', () => {
  const topbarJsPath = path.join(rootDir, 'frontend', 'js', 'components', 'topbar.js');
  const appJsPath = path.join(rootDir, 'frontend', 'js', 'app.js');
  const responsiveCssPath = path.join(rootDir, 'frontend', 'styles', 'responsive.css');
  const layoutCssPath = path.join(rootDir, 'frontend', 'styles', 'layout.css');
