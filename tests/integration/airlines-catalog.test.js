...
import { AIRLINES as FRONTEND_AIRLINES, findAirline, getAirlineByCode, getAirlineLabel, renderAirlineOptionsHtml } from '../../frontend/js/data/airlines.js';
import { AIRLINES as SERVER_AIRLINES, findAirline as serverFindAirline, getAirlineByCode as serverGetAirlineByCode } from '../../backend/src/constants/airlines.js';
