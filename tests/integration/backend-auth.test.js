...
import { authenticate, requireRole, lastActiveTouchCache } from '../../backend/src/middleware/auth.js';
import { setPrismaClient } from '../../backend/src/config/database.js';
import { env } from '../../backend/src/config/env.js';
import { UnauthorizedError, ForbiddenError } from '../../backend/src/domain/errors.js';
import { isEmployeeOnline, formatLastSeen } from '../../frontend/js/utils/online-status.js';
