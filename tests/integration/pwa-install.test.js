...
async function runPwaTests() {
  ...
  const iconFiles = [
    ...
    'frontend/assets/icon-512-maskable.png'
  ];
  ...
  const manifestBuild = vercelConfig.builds?.find(b => b.src === 'frontend/manifest.json' || b.src === 'manifest.json');
  const swBuild = vercelConfig.builds?.find(b => b.src === 'frontend/sw.js' || b.src === 'sw.js');
