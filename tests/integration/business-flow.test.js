 ...
 *
 * Run with: npm test  (or node tests/integration/business-flow.test.js)
 */

import { validatePayment } from '../../frontend/js/domain/payment-rules.js';
import { validateRefund } from '../../frontend/js/domain/refund-rules.js';
import { validateModification } from '../../frontend/js/domain/modification-rules.js';
import {
  calculateTotalPaid,
  calculateRemaining,
...
import { CustomerService } from '../../frontend/js/services/customer-service.js';
import { ReportService, buildReportFromTickets } from '../../frontend/js/services/report-service.js';
...
import { setSession, getStoredUser, clearSession, hasSession, setAccessToken } from '../../frontend/js/services/api-client.js';
import { LoginPage } from '../../frontend/js/pages/login.js';
