...
const { setPrismaClient } = await import('../../backend/src/config/database.js');
const { CustomerService } = await import('../../backend/src/services/customer.service.js');
const { TicketService } = await import('../../backend/src/services/ticket.service.js');
const { AuthService } = await import('../../backend/src/services/auth.service.js');
const { errorHandler } = await import('../../backend/src/middleware/error-handler.js');
