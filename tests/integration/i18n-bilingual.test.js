...
import { i18n, t, has, getUserRoleLabel } from '../../frontend/js/i18n/i18n.js';
...
import {
  ...
  formatDateTime,
  formatRelativeTime
} from '../../frontend/js/utils/calculations.js';
...
const baseCssPath = path.resolve(__dirname, '../../frontend/styles/base.css');
