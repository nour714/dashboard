...
✅ اتعمل **الـ Private Storage Bucket** باسم **`customer-documents`** لتخزين جوازات السفر والمستندات بحد أقصى 10MB وأنواع الملفات المسموحة (`image/jpeg`, `image/png`, `application/pdf`).
...
- **حدود الملفات:** الحد الأقصى لحجم الملف هو 10MB (`10485760` بايت) والأنواع المسموحة هي (`image/jpeg`, `image/png`, `application/pdf`) متوافقة تماماً مع ثوابت `server/src/middleware/upload.js`.
